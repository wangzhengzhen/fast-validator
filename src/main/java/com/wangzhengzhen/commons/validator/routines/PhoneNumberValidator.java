 ...
 *
 */
public class PhoneNumberValidator implements IValidator<IsPhoneNumber> {
	...
	public String failureDesc() {
		...
		return phoneNumberAnno.failureDesc();
	}

	public int failureDescResId() {

		return phoneNumberAnno.failureDescResId();
	}
	
	public String failureCode() {
		
		return phoneNumberAnno.failureCode();
	}
}
